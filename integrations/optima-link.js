/* ============================================
   OPTIMA LINK — Integração com OPTIMA WORK AI
   Deep link e comunicação com o app externo
   ============================================ */

const OptimaLink = (function () {
  let config = null;
  ...
  /* Abre com contexto do maquinista */
  ...
  /* Verifica se o OPTIMA está acessível */
